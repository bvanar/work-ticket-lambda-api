...
namespace well_project_api.Services
{
    public class JobService
    {
        ...
        public JobService(WellDbContext db, IMapper mapper)
        {
            _db = db;
            _mapper = mapper;
        }
        ...
        public async Task<List<JobDto>> GetUserJobs(int userId)
        {
            ...
            var jobs = await _db.Job.Where(z => jobIds.Contains(z.JobId)).ToListAsync();
        ...
        public async Task AssignUsersToJob(UserJobRequestDto userJob)
        {
